...
if wersja==1
    ...
    print('wersja1_pid_u.png','-dpng','-r400');
    ...
    print('wersja1_pid_y.png','-dpng','-r400');
elseif wersja==2
    figure
    hold on;
    stairs(1:kk,u4)
    ...
    print('wersja2_pid_u.png','-dpng','-r400');
    ...
    ylabel('y')
    legend('y1','y2','y3','yzad','Location','southeast')
    print('wersja2_pid_y.png','-dpng','-r400');
elseif wersja==3
    figure
    hold on;
    stairs(1:kk,u4)
    ...
    print('wersja3_pid_u.png','-dpng','-r400');
    ...
    ylabel('y')
    legend('y1','y2','y3','yzad','Location','southeast')
    print('wersja3_pid_y.png','-dpng','-r400');
end
